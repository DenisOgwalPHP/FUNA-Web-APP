        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
              <li><a href="pages/tables/ACCGeneralStockIn.php"><i class="fa fa-circle-o"></i> Regional</a></li>
               <li><a href="pages/tables/ACCMainOfficeStockIn.php"><i class="fa fa-circle-o"></i> Main Office</a></li>
                <li><a href="pages/tables/ACCShopStockIn.php"><i class="fa fa-circle-o"></i> Per Shop</a></li>
                <li><a href="pages/tables/ACCDateStockIn.php"><i class="fa fa-circle-o"></i> Per date</a></li>
                <li><a href="pages/tables/ACCTSEStockIn.php"><i class="fa fa-circle-o"></i> Per TSE</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/examples/ACCStockInGeneralreport.php"><i class="fa fa-circle-o"></i> General</a></li>
                <li><a href="pages/examples/ACCStockInShopreport.php"><i class="fa fa-circle-o"></i> Per Shop</a></li>
                <li><a href="pages/examples/ACCStockInDatereport.php"><i class="fa fa-circle-o"></i> Per date</a></li>
                 <li><a href="pages/examples/ACCStockInTSEreport.php"><i class="fa fa-circle-o"></i> Per TSE</a></li>
              </ul>
            </li>
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
              <li><a href="pages/tables/ACCShopSales.php"><i class="fa fa-circle-o"></i> By Shop</a></li>
               <li><a href="pages/tables/ACCSalesByTSE.php"><i class="fa fa-circle-o"></i>By TSE</a></li>
              </ul>
            </li>
           <li class="treeview">
              <a href="pages/tables/ACCExpensesRecord.php">
