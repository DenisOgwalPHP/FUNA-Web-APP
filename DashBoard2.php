        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
              <li><a href="pages/tables/REGGeneralStockIn.php"><i class="fa fa-circle-o"></i> Regional</a></li>
               <li><a href="pages/tables/REGMainOfficeStockIn.php"><i class="fa fa-circle-o"></i> Main Office</a></li>
                <li><a href="pages/tables/REGShopStockIn.php"><i class="fa fa-circle-o"></i> Per Shop</a></li>
                <li><a href="pages/tables/REGDateStockIn.php"><i class="fa fa-circle-o"></i> Per date</a></li>
                <li><a href="pages/tables/REGTSEStockIn.php"><i class="fa fa-circle-o"></i> Per TSE</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/examples/REGStockInGeneralreport.php"><i class="fa fa-circle-o"></i> General</a></li>
                <li><a href="pages/examples/REGStockInShopreport.php"><i class="fa fa-circle-o"></i> Per Shop</a></li>
                <li><a href="pages/examples/REGStockInDatereport.php"><i class="fa fa-circle-o"></i> Per date</a></li>
                 <li><a href="pages/examples/REGStockInTSEreport.php"><i class="fa fa-circle-o"></i> Per TSE</a></li>
              </ul>
            </li>
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
              <li><a href="pages/tables/REGShopSales.php"><i class="fa fa-circle-o"></i> By Shop</a></li>
               <li><a href="pages/tables/REGSalesByTSE.php"><i class="fa fa-circle-o"></i>By TSE</a></li>
              </ul>
            </li>
           <li class="treeview">
              <a href="pages/tables/REGExpensesRecord.php">
