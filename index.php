<!--
Author: Denis Ogwal
Author URL: http://EssenceTechnologiesUG.com
-->
<?php
//session_start();
?>
...
<div data-vide-bg="video/keyboard">
	<div class="main-container">
		...
		<div class="main-content-agile">
			...
			<div class="sub-main-w3ls">	
				<form action="login.php" method="post">
					<input name="email" type="text" required placeholder="Enter your Staff No" autocomplete="on">
					...
					<div class="checkbox-w3">
						...
						<a href="pages/examples/register.php">I have No Account!</a>
						<div class="clear"></div>
					</div>
		...
		<!--footer-->
		<div class="footer">
			<p>Copyright &copy; 2017 FUNA. All rights reserved <!--| Design by <a href="http://"></a>--></p>
		</div>
		<!--//footer-->
	</div>
</div>
