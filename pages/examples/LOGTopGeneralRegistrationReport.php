...
<html>
  <head>
    <meta charset="UTF-8">
    <title>FUNA | General Shop Registration Report</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            General Shop Registration Report
            <small>#</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../DashBoard1.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="LOGTopGeneralRegistrationReport.php">Registration Report</a></li>
...
while($row9=mysqli_fetch_assoc($result9)){
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="LOGTopGeneralRegistrationReportPrint.Php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
