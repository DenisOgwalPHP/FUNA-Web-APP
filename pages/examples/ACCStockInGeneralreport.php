        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="ACCStockInGeneralreport.php"><i class="fa fa-circle-o"></i> General</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="ACCStockInGeneralreport.php">General Report</a></li>
...
while($row7=mysqli_fetch_assoc($result7)){
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="ACCStockInGeneralReportPrint.php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
