          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="ACCStockInDatereport.php"><i class="fa fa-circle-o"></i> Per date</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="ACCStockInDatereport.php">Sales Report</a></li>
        ...
        <div class="pad margin no-print">
         &nbsp;  &nbsp;  &nbsp;
                    <form action="ACCStockInDateReport.php" method="post">
...
while($row7=mysqli_fetch_assoc($result7)){
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="ACCStockInDateReportPrint.php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
