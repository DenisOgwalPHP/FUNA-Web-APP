      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="TopGeneralRegistrationReport.php">Registration Report</a></li>
...
while($row9=mysqli_fetch_assoc($result9)){
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="TopGeneralRegistrationReportPrint.Php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
