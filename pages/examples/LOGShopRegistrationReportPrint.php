...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Funa | Shop Staff Registration Print</title>
  ...
  <body onload="window.print();">
    <div class="wrapper">
      ...
      <section class="invoice">
        ...
        <!-- info row -->
        <div class="row">
       <h3 align="center">A full registration List Of members of staff at <?php echo"".$_SESSION['shopsname']; ?> </h3>
        </div><!-- /.row -->
