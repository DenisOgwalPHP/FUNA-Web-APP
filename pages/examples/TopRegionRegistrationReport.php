      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="TopRegionalRegistrationReport.php">Registration Report</a></li>
        ...
        <div class="pad margin no-print">
         <div class="pad margin no-print">
         &nbsp; <form action="TopRegionRegistrationReport.php" method="post">
                   <div>
...
while($row9=mysqli_fetch_assoc($result9)){
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="TopRegionalRegistrationReportPrint.Php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
