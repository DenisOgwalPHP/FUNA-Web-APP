        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
               <li class="active"><a href="StockInDatereport.php"><i class="fa fa-circle-o"></i> Stock In</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="StockInDatereport.php">Sales Report</a></li>
        ...
        <div class="pad margin no-print">
         &nbsp;  &nbsp;  &nbsp;
                    <form action="StockInDateReport.php" method="post">
...
while($row7=mysqli_fetch_assoc($result7)){
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="StockInDateReportPrint.php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
