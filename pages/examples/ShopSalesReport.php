...
<html>
  <head>
    <meta charset="UTF-8">
    <title>FUNA | Shop Sales Report</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="ShopSalesReport.php">Sales Report</a></li>
            <li class="active">Shop Sales Report</li>
          </ol>
        </section>
        ...
        <section class="invoice">
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="ShopSalesReportPrint.php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
