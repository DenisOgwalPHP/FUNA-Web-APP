      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="LOGShopRegistrationReport.php">Registration Report</a></li>
            <li class="active">Shop Staff Registration Report</li>
          </ol>
        </section>

        <div class="pad margin no-print">
        &nbsp;<form action="LOGShopRegistrationReport.php" method="post">
                   <div>
...
while($row9=mysqli_fetch_assoc($result9)){
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="LOGShopRegistrationReportPrint.php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
