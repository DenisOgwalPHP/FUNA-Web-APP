  ...
  <body class="skin-yellow">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="SalesGeneralreport.php">Sales Report</a></li>
	...
	$grandtotaldiscounted=$discountedshop+$discountedshop1;
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="SalesClosingReportPrint.php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
