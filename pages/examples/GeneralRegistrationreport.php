        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="GeneralRegistrationReport.php"><i class="fa fa-circle-o"></i> General</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="GeneralRegistrationReport.php">Registration Report</a></li>
...
while($row9=mysqli_fetch_assoc($result9)){
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="GeneralRegistrationReportPrint.Php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
