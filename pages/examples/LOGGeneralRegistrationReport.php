...
<html>
  <head>
    <meta charset="UTF-8">
    <title>FUNA | General Registration Report</title>
    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="LOGGeneralRegistrationReport.php"><i class="fa fa-circle-o"></i> General</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            General Staff Registration Report
            <small>#</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../DashBoard1.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="LOGGeneralRegistrationReport.php">Registration Report</a></li>
            <li class="active">General Registration Report</li>
          </ol>
        </section>
        ...
        <div class="pad margin no-print">
          <div class="callout callout-warning" style="margin-bottom: 0!important;">												
            ...
            This page displays Staff Registrered in Details. Click the print button at the bottom of the report to Print.
          </div>
        </div>
...
while($row9=mysqli_fetch_assoc($result9)){
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="LOGGeneralRegistrationReportPrint.Php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
