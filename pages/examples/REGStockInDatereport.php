          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="REGStockInDatereport.php"><i class="fa fa-circle-o"></i> Per date</a></li>
                 <li><a href="REGStockInTSEreport.php"><i class="fa fa-circle-o"></i> Per TSE</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="REGStockInDatereport.php">Sales Report</a></li>
        ...
        <div class="pad margin no-print">
         &nbsp;  &nbsp;  &nbsp;
                    <form action="REGStockInDateReport.php" method="post">
...
while($row7=mysqli_fetch_assoc($result7)){
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="REGStockInDateReportPrint.php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
