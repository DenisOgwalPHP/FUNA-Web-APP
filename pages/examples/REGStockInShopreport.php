    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="REGStockInShopreport.php"><i class="fa fa-circle-o"></i> Per Shop</a></li>
      ...
      <div class="content-wrapper">
        ...
        <div class="pad margin no-print">
                    &nbsp;  &nbsp;  &nbsp;<form action="REGStockInShopreport.php" method="post">
                   <div>
...
while($row7=mysqli_fetch_assoc($result7)){
 ...
 $totalstock+=$row7['MoneyWorth'];
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="REGStockInShopreportPrint.php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
