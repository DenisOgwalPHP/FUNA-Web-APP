      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="ShopStockReport.php">Stock Report</a></li>
        ...
        <section class="invoice">
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="ShopStockReportPrint.php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
