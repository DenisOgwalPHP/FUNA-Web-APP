            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="ACCStockInDatereport.php"><i class="fa fa-circle-o"></i> Per date</a></li>
                 <li class="active"><a href="ACCStockInTSEreport.php"><i class="fa fa-circle-o"></i> Per TSE</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <div class="pad margin no-print">
         <h3 class="box-title">TSE Stock In Details</h3>
                     &nbsp;  &nbsp;  &nbsp;<form action="ACCStockInTSEreport.php" method="post">
                   <div>
...
while($row8=mysqli_fetch_assoc($result8)){
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="ACCStockInTSEreportPrint.php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
