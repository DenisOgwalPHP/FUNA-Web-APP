          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
               ...
               <li class="active"><a href="StockInGeneralreport.php"><i class="fa fa-circle-o"></i> Curent Stock By Shop</a></li>
              </ul>
            </li>
               <li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="StockInGeneralreport.php">General Report</a></li>
...
while($row7=mysqli_fetch_assoc($result7)){
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="StockInGeneralReportPrint.php" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</a>
