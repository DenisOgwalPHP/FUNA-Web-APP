  ...
  <head>
	...
	/* calculating final sums*/	
	 function calculatetotal(){
		...
		var minus=parseInt(tottot5)*0.05;
		var payable=parseInt(tottot5)-parseInt(minus);
		Payableammount.value=payable;
		}					
    </script>
  </head>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="ShopAddSales.php">Form</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form action="../../includes/ShopInsertSales.php" method="post">
                  <div class="box-body">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <label for="exampleInputPassword1">Total:</label> &nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
               <label for="exampleInputPassword1">Payable:</label> <br>	
               <br>	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <input type="number" class="form-horizontal" name="overallammount"id="overallammount" placeholder="Total" readonly>&nbsp;&nbsp;
                   
                     <input type="number" class="form-horizontal" name="Payableammount" id="Payableammount" placeholder="Ammount Payable" readonly>  
                  </div>
                  <div>&nbsp;</div>
              </div><!-- /.box -->
</div>
            ...
            <div class="col-md-6">
              ...
              <div class="box box-warning">
                <div class="box-header">
                  <h3 class="box-title"> Shop Sales</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
$shops = $_SESSION['Shop'];	
$finalpayment=0;	
$sales9 ="SELECT Date,StaffNo,Denomination,Quantity,DiscountedMoneyRecieved FROM `shopsales` where Date Like '$dates%' and ShopName='$shops' order by ShopSalesID Desc";
...
while($row9=mysqli_fetch_assoc($result9)){
                    ...
                    echo" <tr>";
					 ...
					 echo  "<td>".$row9['Quantity']."</td>";
					  echo  "<td>".$row9['DiscountedMoneyRecieved']."</td>";
                   echo" </tr>" ;
				   $counter5++;
				   $finalpayment+=$row9['DiscountedMoneyRecieved'];
}
					?>
                    </tbody>
                    <tfoot>
