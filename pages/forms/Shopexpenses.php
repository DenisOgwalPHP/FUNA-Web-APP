      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="Shopexpense.php">Form</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form action="../../includes/InsertShopExpenses.php" method="post">
                  <div class="box-body">
...
require_once('../../connect/connect.php');
	$dates5=date("Y-m-d");
	$shop=$_SESSION['Shop'];
$sales9 ="SELECT Date,Expense,Description,ExpenseBy,Shop,ExpenseCost FROM `expenses` where Date like'$dates5%' and Shop='$shop'";
