      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="LOGStaffRegistration.php">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="LOGStockInForm.php">Form</a></li>
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Add Stock to shops</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form action="../../includes/LOGTopInsertStockIn.php" method="post">
                  <div class="box-body">
                   <div class="form-group" align="center">
                   <Select size="1" name="shop" class="form-control" required>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="col-md-6">
              ...
              <div class="box box-warning">
                <div class="box-header">
                  <h3 class="box-title"> Shops Stock In</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                   <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
require_once('../../connect/connect.php');
$sales9 ="SELECT Date,Shop,Denomination,Quantity,MoneyWorth,IssuedBy FROM `shopstock`";
$result9=mysqli_query($link,$sales9);
$counter5=1;
$firstshop10=0;
while($row9=mysqli_fetch_assoc($result9)){
