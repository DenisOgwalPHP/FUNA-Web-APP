...
<html>
  <head>
    <meta charset="UTF-8">
    <title>FUNA | General Staff Registration</title>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu active">
                <li class="active"><a href="GeneralRegistration.php"><i class="fa fa-circle-o"></i> General</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="GeneralRegistration.php">Registration</a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">General Staff Registration Record</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
