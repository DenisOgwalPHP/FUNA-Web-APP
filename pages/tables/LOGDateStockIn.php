            ...
            <li class="treeview active">
              ...
              <li><a href="LOGGeneralStockIn.php"><i class="fa fa-circle-o"></i> Regional</a></li>
               <li><a href="LOGMainOfficeStockIn.php"><i class="fa fa-circle-o"></i> Main Office</a></li>
                ...
                <li class="active"><a href="LOGDateStockIn.php"><i class="fa fa-circle-o"></i> Per date</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="LOGDateStockIn.php">Stock In Record</a></li>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Stock In By Date Details</h3>
                     &nbsp;  &nbsp;  &nbsp;
                    <form action="LOGDateStockIn.php" method="post">
