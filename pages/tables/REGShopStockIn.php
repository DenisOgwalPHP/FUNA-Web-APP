            ...
            <li class="treeview active">
              ...
              <li><a href="REGGeneralStockIn.php"><i class="fa fa-circle-o"></i> Regional</a></li>
               <li><a href="REGMainOfficeStockIn.php"><i class="fa fa-circle-o"></i> Main Office</a></li>
                <li class="active"><a href="REGShopStockIn.php"><i class="fa fa-circle-o"></i> Per Shop</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="REGShopStockIn.php">Stock In Record</a></li>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Shop Stock In Details</h3>
                    &nbsp;  &nbsp;  &nbsp;<form action="REGShopStockIn.php" method="post">
                   <div>
