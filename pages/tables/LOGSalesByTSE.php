            ...
            <li class="treeview">
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu active">
                ...
                <li class="active"><a href="LOGSalesByTSE.php"><i class="fa fa-circle-o"></i> Per TSE</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="LOGSalesByTSE.php">Sales Record</a></li>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">TSE Sales Details</h3>
                     &nbsp;  &nbsp;  &nbsp;<form action="LOGSalesByTSE.php" method="post">
                   <div>
