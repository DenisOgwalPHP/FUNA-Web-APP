            ...
            <li class="treeview active">
              ...
              <li><a href="ACCGeneralStockIn.php"><i class="fa fa-circle-o"></i> Regional</a></li>
               <li><a href="ACCMainOfficeStockIn.php"><i class="fa fa-circle-o"></i> Main Office</a></li>
                ...
                <li class="active"><a href="ACCTSEStockIn.php"><i class="fa fa-circle-o"></i> Per TSE</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="TSEStockIn.php">TSE In Record</a></li>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">TSE Stock In Details</h3>
                     &nbsp;  &nbsp;  &nbsp;<form action="ACCTSEStockIn.php" method="post">
                   <div>
