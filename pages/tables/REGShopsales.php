          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
              <li class="active"><a href="REGShopSales.php"><i class="fa fa-circle-o"></i> By Shop</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="REGShopSales.php">SalesRecord</a></li>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Approved Shop Sales</h3>
                   <form action="REGShopSales.php" method="post">
                   <div>
                   &nbsp;  &nbsp;  &nbsp;
