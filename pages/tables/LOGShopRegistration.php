        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
              <li><a href="LOGGeneralStockIn.php"><i class="fa fa-circle-o"></i> Regional</a></li>
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li><a href="LOGGeneralRegistration.php"><i class="fa fa-circle-o"></i> General</a></li>
                 <li class="active"><a href="LOGShopRegistration.php"><i class="fa fa-circle-o"></i> By Shop</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="LOGShopRegistration.php">Registration</a></li>
            <li class="active">Shop registration</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Shop Staff Registration Record</h3>
                  
                   &nbsp;  &nbsp;  &nbsp;<form action="LOGShopRegistration.php" method="post">
                   <div>
