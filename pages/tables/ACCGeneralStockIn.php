          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../../DashBoard3.php"><i class="fa fa-circle-o"></i>Main Menu</a></li>
              </ul>
            </li>
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
              <li class="active"><a href="ACCGeneralStockIn.php"><i class="fa fa-circle-o"></i> Regional</a></li>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Regional Stock In Details</h3>
                   &nbsp;  &nbsp;  &nbsp;<form action="ACCGeneralStockIn.php" method="post">
