            ...
            <li class="treeview">
             ...
             <li class="treeview active">
              ...
              <li><a href="REGShopSales.php"><i class="fa fa-circle-o"></i> By Shop</a></li>
               <li class="active"><a href="REGSalesByTSE.php"><i class="fa fa-circle-o"></i>By TSE</a></li>
              </ul>
            </li>
           <li class="treeview">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="REGSalesByTSE.php">Sales Record</a></li>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">TSE Sales Details</h3>
                     &nbsp;  &nbsp;  &nbsp;<form action="REGSalesByTSE.php" method="post">
                   <div>
