        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
              <li class="active"><a href="GeneralStockIn.php"><i class="fa fa-circle-o"></i> Regional</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="GeneralStockIn.php">Stock In Record</a></li>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Regional Stock In Details</h3>
                   &nbsp;  &nbsp;  &nbsp;<form action="GeneralStockIn.php" method="post">
