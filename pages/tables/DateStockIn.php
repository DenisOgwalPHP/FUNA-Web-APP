            ...
            <li class="treeview active">
              ...
              <li><a href="GeneralStockIn.php"><i class="fa fa-circle-o"></i> Regional</a></li>
               <li><a href="MainOfficeStockIn.php"><i class="fa fa-circle-o"></i> Main Office</a></li>
                ...
                <li class="active"><a href="DateStockIn.php"><i class="fa fa-circle-o"></i> Per date</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="DateStockIn.php">Stock In Record</a></li>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Stock In By Date Details</h3>
                     &nbsp;  &nbsp;  &nbsp;
                    <form action="DateStockIn.php" method="post">
