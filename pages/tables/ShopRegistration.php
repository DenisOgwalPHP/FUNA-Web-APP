          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../../DashBoard.php"><i class="fa fa-circle-o"></i>Main Menu</a></li>
              </ul>
            </li>
            <li>
            ...
            <li class="treeview">
              ...
              <li><a href="GeneralStockIn.php"><i class="fa fa-circle-o"></i> Regional</a></li>
               <li><a href="MainOfficeStockIn.php"><i class="fa fa-circle-o"></i> Main Office</a></li>
                <li><a href="ShopStockIn.php"><i class="fa fa-circle-o"></i> Per Shop</a></li>
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li><a href="GeneralRegistration.php"><i class="fa fa-circle-o"></i> General</a></li>
                 <li class="active"><a href="ShopRegistration.php"><i class="fa fa-circle-o"></i> By Shop</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="ShopRegistration.php">Registration</a></li>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Shop Staff Registration Record</h3>
                   ...
                   &nbsp;  &nbsp;  &nbsp;<form action="ShopRegistration.php" method="post">
                   <div>
