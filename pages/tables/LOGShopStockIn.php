            ...
            <li class="treeview active">
              ...
              <li><a href="LOGGeneralStockIn.php"><i class="fa fa-circle-o"></i> Regional</a></li>
               <li><a href="LOGMainOfficeStockIn.php"><i class="fa fa-circle-o"></i> Main Office</a></li>
                <li class="active"><a href="LOGShopStockIn.php"><i class="fa fa-circle-o"></i> Per Shop</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="LOGShopStockIn.php">Stock In Record</a></li>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Shop Stock In Details</h3>
                    &nbsp;  &nbsp;  &nbsp;<form action="LOGShopStockIn.php" method="post">
                   <div>
